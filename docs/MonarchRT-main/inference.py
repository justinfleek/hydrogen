...
if args.use_torch_compile:
    torch.backends.cudnn.benchmark = True # additional optimization
    # NOTE: might need to set these
...
for i, batch_data in tqdm(enumerate(dataloader), disable=(local_rank != 0)):
    ...
    if args.i2v:
        ...
        initial_latent = pipeline.vae.encoder(image).to(device=device, dtype=torch.bfloat16)
