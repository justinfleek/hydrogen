...
class CausalWanSelfAttention(nn.Module):
    ...
    def forward(
        ...
        nframes, frame_height, frame_width = grid_size
        frame_seqlen = frame_height * frame_width
        ...
        if kv_cache is None:
            ...
            current_end = current_start_frame * frame_seqlen + roped_query.shape[1]
            ...
            if self.local_attn_size != -1 and (current_end > kv_cache["global_end_index"]) and (
                ...
                cache_start = max(0, local_end_index - self.local_attn_size * frame_seqlen)
            else:
...
class CausalWanAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        y = self.self_attn(
            ...
            grid_size, block_mask, rope_cache, kv_cache, current_start_frame)
...
class CausalWanModel(ModelMixin, ConfigMixin):
    ...
    def _forward_inference(
        ...
        rope_cache = build_cos_sin_cache_3d(self.freqs_t, self.freqs_h, self.freqs_w, *grid_size, x.shape[0], start_frame=current_start_frame, device=device)
    ...
    def _forward_train(
        ...
        # don't construct mask when using Monarch
        if self.block_mask is None and not self.enable_monarch:
