...
showElement (Element.Image _) = "Element.Image { ... }"
showElement (Element.Video _) = "Element.Video { ... }"
showElement (Element.Audio _) = "Element.Audio { ... }"
showElement (Element.Model3D _) = "Element.Model3D { ... }"
