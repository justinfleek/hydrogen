...
-- | ## Dependencies
-- |
-- | - Hydrogen.Schema.Surface.NoiseFrequency
-- | - Hydrogen.Schema.Surface.NoiseAmplitude
-- | - Hydrogen.Schema.Surface.NoiseOctaves
-- | - Hydrogen.Schema.Surface.NoiseLacunarity
-- | - Hydrogen.Schema.Surface.NoisePersistence
-- | - Hydrogen.Schema.Surface.NoiseSeed
...
import Hydrogen.Schema.Surface.NoiseFrequency (NoiseFrequency)
import Hydrogen.Schema.Surface.NoiseFrequency (noiseFrequency, standard) as Freq
import Hydrogen.Schema.Surface.NoiseAmplitude (NoiseAmplitude)
import Hydrogen.Schema.Surface.NoiseAmplitude (noiseAmplitude, full) as Amp
import Hydrogen.Schema.Surface.NoiseOctaves (NoiseOctaves)
import Hydrogen.Schema.Surface.NoiseOctaves (noiseOctaves, standard) as Oct
import Hydrogen.Schema.Surface.NoiseLacunarity (NoiseLacunarity)
import Hydrogen.Schema.Surface.NoiseLacunarity (noiseLacunarity, standard) as Lac
import Hydrogen.Schema.Surface.NoisePersistence (NoisePersistence)
import Hydrogen.Schema.Surface.NoisePersistence (noisePersistence, standard) as Pers
import Hydrogen.Schema.Surface.NoiseSeed (NoiseSeed)
import Hydrogen.Schema.Surface.NoiseSeed (zero) as Seed
