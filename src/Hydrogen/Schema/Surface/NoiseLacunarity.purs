-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--                         // hydrogen // schema // surface // noise-lacunarity
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
module Hydrogen.Schema.Surface.NoiseLacunarity
  ( NoiseLacunarity
  , noiseLacunarity
  , unwrap
  , toNumber
...
-- |
-- | Note: Lacunarity controls how detail frequency increases per octave.
-- | Typical values: 1.5-3.0. 10 is extreme.
bounds :: Bounded.NumberBounds
bounds = Bounded.numberBounds 1.0 10.0 Bounded.Clamps "noiseLacunarity" "FBM frequency multiplier per octave"
