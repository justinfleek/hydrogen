...
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--                                               // Foundry.Core.Effects.Grade
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
--
--  Type-level grade lattice for Foundry graded monads.
--
--  Effect categories form a bounded join-semilattice:
--
--      Pure ⊑ Net ⊑ Net∪Auth ⊑ ... ⊑ ⊤
--
--  Composition (Plus) is set union: if f : FoundryM '[Net] a and
--  g : FoundryM '[Auth] b, then (f >>= \_ -> g) : FoundryM '[Net, Auth] b.
--
--  This is the type-level tracking. Runtime cost data (latency, tokens,
--  timestamps) is still accumulated at the value level in FoundryGrade,
--  FoundryCoEffect, and FoundryProvenance — those are orthogonal.
--
--  Corresponds to Continuity.lean's Coeffect inductive type, lifted to kinds.
--
--  Based on Orchard & Petricek's effect-monad library (Control.Effect).
--
-- ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
