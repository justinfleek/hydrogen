...
(() => {
  ...
  // output/Extension.Chrome/foreign.js
  var queryActiveTabImpl = (onSuccess) => (onError) => () => {
  ...
  var sendMessageToBackgroundImpl = (message2) => (onSuccess) => (onError) => () => {
  ...
  // output/Extension.Chrome/index.js
  var pure1 = /* @__PURE__ */ pure(applicativeAff);
  var sendMessageToBackground = function(message2) {
    return makeAff(function(callback) {
      return function __do2() {
        sendMessageToBackgroundImpl(message2)(function(response) {
          return callback(new Right(response));
        })(function(err) {
          return callback(new Left(error(err)));
        })();
        return nonCanceler;
      };
    });
  };
  var queryActiveTab = /* @__PURE__ */ makeAff(function(callback) {
    return function __do2() {
      queryActiveTabImpl(function(tab) {
        return callback(new Right(tab));
      })(function(err) {
        return callback(new Left(error(err)));
      })();
      return nonCanceler;
  ...
  var getActiveTabId = /* @__PURE__ */ bind(bindAff)(queryActiveTab)(function(tab) {
    return pure1(tab.id);
  });

  // output/Extension.Response/foreign.js
  var parseRawResponse = function(foreign) {
    ...
    const error4 = foreign.error || null;
    let data = null;
    if (foreign.data && typeof foreign.data === "object") {
      const rawData = foreign.data;
      const screenshot = typeof rawData.screenshot === "string" ? rawData.screenshot : null;
      let extraction = null;
      if (rawData.extraction && typeof rawData.extraction === "object") {
        ...
        extraction = {
          ...
          layers: Array.isArray(ext.layers) ? ext.layers.map(function(layer) {
            return {
  ...
  // output/Extension.Response/index.js
  var map5 = /* @__PURE__ */ map(functorArray);
  var convertLayers = function(rawLayers) {
    var convertLayer = function(raw) {
      return {
        zIndex: raw.zIndex,
        count: raw.count
      };
    };
    return map5(convertLayer)(rawLayers);
  };
  var parseExtractionResponse = function(foreign$prime) {
    var parsePayload = function(payload) {
      var v = toMaybe(payload.extraction);
      if (v instanceof Nothing) {
        return new Left("Response data but no extraction");
      }
      ;
      if (v instanceof Just) {
        var maybeScreenshot = toMaybe(payload.screenshot);
        var layers = convertLayers(v.value0.layers);
        var result = {
          url: v.value0.url,
          title: v.value0.title,
          elementCount: v.value0.count,
          layerCount: v.value0.layerCount,
          layers
        };
        return new Right(new Tuple(result, maybeScreenshot));
      }
      ;
      throw new Error("Failed pattern match at Extension.Response (line 115, column 7 - line 130, column 49): " + [v.constructor.name]);
    };
    var parseSuccess = function(raw2) {
      var v = toMaybe(raw2.data);
      if (v instanceof Nothing) {
        return new Left("Response success but no data");
      }
      ;
      if (v instanceof Just) {
        return parsePayload(v.value0);
      }
      ;
      throw new Error("Failed pattern match at Extension.Response (line 108, column 7 - line 112, column 31): " + [v.constructor.name]);
    };
    var parseError = function(raw2) {
      var v = toMaybe(raw2.error);
      if (v instanceof Just) {
        return new Left(v.value0);
      }
      ;
      if (v instanceof Nothing) {
        return new Left("Unknown error");
      }
      ;
      throw new Error("Failed pattern match at Extension.Response (line 133, column 7 - line 135, column 40): " + [v.constructor.name]);
    };
    var raw = parseRawResponse(foreign$prime);
    if (raw.success) {
  ...
  // output/Extension.Popup/index.js
  ...
  var Extracting = /* @__PURE__ */ (function() {
    function Extracting2() {
    }
    ;
    Extracting2.value = new Extracting2();
    return Extracting2;
  })();
  ...
  var TriggerExtract = /* @__PURE__ */ (function() {
    function TriggerExtract2() {
    }
    ;
    TriggerExtract2.value = new TriggerExtract2();
    return TriggerExtract2;
  })();
  var ExtractionComplete = /* @__PURE__ */ (function() {
    function ExtractionComplete2(value0, value1) {
      this.value0 = value0;
      this.value1 = value1;
    }
    ;
    ExtractionComplete2.create = function(value0) {
      return function(value1) {
        return new ExtractionComplete2(value0, value1);
      };
    };
    return ExtractionComplete2;
  })();
  var ExtractionFailed = /* @__PURE__ */ (function() {
    function ExtractionFailed2(value0) {
      this.value0 = value0;
    }
    ;
    ExtractionFailed2.create = function(value0) {
      return new ExtractionFailed2(value0);
    };
    return ExtractionFailed2;
  })();
  var renderStatus = function(result) {
    return div2([class_("popup-status")])([div2([class_("status-row")])([span2([class_("status-label")])([text("Elements")]), span2([class_("status-value success")])([text(show2(result.elementCount))])]), div2([class_("status-row")])([span2([class_("status-label")])([text("Layers")]), span2([class_("status-value")])([text(show2(result.layerCount))])])]);
  };
  var renderScreenshot = function(v) {
    if (v instanceof Nothing) {
      return text("");
    }
    ;
    if (v instanceof Just) {
      return div2([class_("screenshot-preview")])([img([src2(v.value0)])]);
    }
    ;
    throw new Error("Failed pattern match at Extension.Popup (line 274, column 1 - line 274, column 72): " + [v.constructor.name]);
  };
  var renderLoading = /* @__PURE__ */ div2([/* @__PURE__ */ class_("loading")])([/* @__PURE__ */ div2([/* @__PURE__ */ class_("spinner")])([]), /* @__PURE__ */ span2([/* @__PURE__ */ class_("loading-text")])([/* @__PURE__ */ text("Extracting visual DNA...")])]);
  var renderLayerItem = function(layer) {
    return li([class_("layer-item")])([span2([class_("layer-z")])([text("z:" + show2(layer.zIndex))]), span2([class_("layer-count")])([text(show2(layer.count) + " elements")])]);
  };
  var renderLayers = function(layers) {
    return div2([class_("result-section")])([h3_([text("Z-Index Layers")]), ul([class_("layer-list")])(map9(renderLayerItem)(layers))]);
  };
  var renderResults = function(result) {
    return function(maybeScreenshot) {
      return div2([class_("popup-results")])([renderStatus(result), renderLayers(result.layers), renderScreenshot(maybeScreenshot)]);
    };
  };
  var renderHeader = /* @__PURE__ */ header([/* @__PURE__ */ class_("popup-header")])([/* @__PURE__ */ h1_([/* @__PURE__ */ text("Foundry")]), /* @__PURE__ */ span2([/* @__PURE__ */ class_("version")])([/* @__PURE__ */ text("v1.0.0")])]);
  var renderError = function(err) {
    return div2([class_("error-message")])([text(err)]);
  };
  var renderEmpty = /* @__PURE__ */ div2([/* @__PURE__ */ class_("popup-status")])([/* @__PURE__ */ div2([/* @__PURE__ */ class_("status-row")])([/* @__PURE__ */ span2([/* @__PURE__ */ class_("status-label")])([/* @__PURE__ */ text("Ready to extract")])])]);
  var renderContent = function(state3) {
    if (state3.status instanceof Extracting) {
    ...
    if (state3.error instanceof Nothing) {
      if (state3.extraction instanceof Just) {
        return renderResults(state3.extraction.value0)(state3.screenshot);
      }
      ;
      if (state3.extraction instanceof Nothing) {
        return renderEmpty;
      }
      ;
      throw new Error("Failed pattern match at Extension.Popup (line 179, column 16 - line 181, column 29): " + [state3.extraction.constructor.name]);
    }
    ;
    throw new Error("Failed pattern match at Extension.Popup (line 177, column 8 - line 181, column 29): " + [state3.error.constructor.name]);
  };
  var parseExtractionResponse2 = parseExtractionResponse;
  var isExtracting = function(v) {
    if (v instanceof Extracting) {
      return true;
    }
    ;
    return false;
  ...
  var initialState = /* @__PURE__ */ (function() {
    return {
      status: Idle.value,
      extraction: Nothing.value,
      screenshot: Nothing.value,
      error: Nothing.value
    };
  })();
  var handleAction = function(dictMonadAff) {
    ...
    return function(v) {
      ...
      ;
      if (v instanceof TriggerExtract) {
        return discard2(modify_3(function(s) {
          ...
          ;
          $34.status = Extracting.value;
          $34.error = Nothing.value;
          return $34;
        }))(function() {
          return bind3(liftAff2(attempt(bind12(getActiveTabId)(function(tabId) {
            var msg = unsafeToForeign({
              action: "fullExtract",
              tabId
            });
            return bind12(sendMessageToBackground(msg))(function(response) {
              return pure12(response);
            });
          }))))(function(result) {
            if (result instanceof Left) {
              return handleAction(dictMonadAff)(new ExtractionFailed("Failed to extract: check console"));
            }
            ;
            if (result instanceof Right) {
              var parsed = parseExtractionResponse2(result.value0);
              if (parsed instanceof Left) {
                return handleAction(dictMonadAff)(new ExtractionFailed(parsed.value0));
              }
              ;
              if (parsed instanceof Right) {
                return handleAction(dictMonadAff)(new ExtractionComplete(parsed.value0.value0, parsed.value0.value1));
              }
              ;
              throw new Error("Failed pattern match at Extension.Popup (line 310, column 9 - line 313, column 68): " + [parsed.constructor.name]);
            }
            ;
            throw new Error("Failed pattern match at Extension.Popup (line 304, column 5 - line 313, column 68): " + [result.constructor.name]);
          });
        });
      }
      ;
      if (v instanceof ExtractionComplete) {
        return modify_3(function(s) {
          ...
          ;
          $45.status = Complete.value;
          $45.extraction = new Just(v.value0);
          $45.screenshot = v.value1;
          $45.error = Nothing.value;
          return $45;
        });
      }
      ;
      if (v instanceof ExtractionFailed) {
        return modify_3(function(s) {
          var $50 = {};
          for (var $51 in s) {
          ...
          ;
          $50.status = Idle.value;
          $50.error = new Just(v.value0);
          return $50;
        });
      }
      ;
      throw new Error("Failed pattern match at Extension.Popup (line 287, column 16 - line 327, column 8): " + [v.constructor.name]);
    };
  };
  var extractButtonText = function(v) {
    ...
    ;
    throw new Error("Failed pattern match at Extension.Popup (line 163, column 1 - line 163, column 38): " + [v.constructor.name]);
  };
  var renderControls = function(state3) {
    return div2([class_("popup-controls")])([button([class_("btn btn-primary"), disabled2(isExtracting(state3.status)), onClick(function(v) {
      return TriggerExtract.value;
    })])([text(extractButtonText(state3.status))])]);
  };
  var render = function(state3) {
    return div2([class_("popup")])([renderHeader, renderControls(state3), renderContent(state3)]);
  };
  ...
  var main2 = /* @__PURE__ */ runHalogenAff(/* @__PURE__ */ discard(discardUnit)(bindAff)(/* @__PURE__ */ liftEffect7(/* @__PURE__ */ log("[Foundry] Popup initializing")))(function() {
    return bind6(awaitBody)(function(body2) {
      return bind6(runUI2(component2)(unit)(body2))(function() {
        return liftEffect7(log("[Foundry] Popup mounted"));
      });
    });
  }));
